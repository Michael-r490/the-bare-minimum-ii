    ...
    FSMQuestion: [
        ...
        content: [
          'To do:',
           ...
           { type: 'image', src: '/FSMq1p1.png', alt: 'Scanner Example' },
      ]
    },
    { 
      id: 'FSMQuestion-slide2', 
      title: 'FSM Exercise', 
      content: [
        'To do:',
           { type: 'bullet', items: [
           ...
           { type: 'image', src: '/FSMq1p2.png', alt: 'Scanner Example' },
      ]
    },
  ],
};
...
const FSMQuestion = () => {
  const [currentSection, setCurrentSection] = useState('FSMQuestion');
