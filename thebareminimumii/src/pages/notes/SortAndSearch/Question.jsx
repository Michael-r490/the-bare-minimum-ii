...
const slides = {
    SortAndSearchQ: [
        { 
         id: 'SortAndSearchQ-slide1', 
        title: 'Excersises', 
         content: [
           { type: 'bullet', items: [
            'Write the algorithm to find the Largest Value in an array',
            'Write the algorithm to find the Index of the Largest Value in an array',
            'Write the algorithm to find the Average Value in an array',
            'Write the algorithm to find a specific Value in an array',
            'Write the algorithm to reverse the contents in an array',
           ] },
           '*optional: Have user inputed arrays*'
      ]
    },
...
const SortAndSearchQ = () => {
  const [currentSection, setCurrentSection] = useState('SortAndSearchQ');
